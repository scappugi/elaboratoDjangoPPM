...
class Recipe(models.Model):
    ...
    description = models.CharField(max_length=200, null=True)  # deve consentire una breve descrizione del piatto
    favorite = models.ManyToManyField(User, related_name='favorite_recipes')
